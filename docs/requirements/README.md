...
For the immediate implementation, use [Mapping Workbook and Scenario JSON MVP Requirements v4.4](../configuration/01_eMAS_Mapping_Configuration_Functional_Requirements.md). The MVP priority is:
