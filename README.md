...
- Fields/Evidence defines reusable semantic fields once; controlled Value Lists provide stable codes, while actual customer observations and their provenance remain execution evidence outside the reusable workbook/JSON configuration.
...
- [Mapping Workbook and Scenario JSON MVP Requirements v4.5](docs/configuration/01_eMAS_Mapping_Configuration_Functional_Requirements.md)
